...
class Vegetarian2Review extends StatelessWidget {
  const Vegetarian2Review({
    Key key,
    @required this.user
  }): super(key: key);
    ...
    return Scaffold(
      body: new Stack(
        ...
        children: <Widget>[
          ...
          StreamBuilder(
              stream:Firestore.instance.collection("dinner_reviews").document("vegetarian").snapshots(),
