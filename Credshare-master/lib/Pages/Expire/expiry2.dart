...
class Expiry2Page extends StatelessWidget{
  const Expiry2Page({
    Key key,
    @required this.user
  }): super(key: key);
              ...
              builder: (context,snapshot) {
                ...
                return Container(
                    ...
                    child: ListView.builder(
                              ...
                              children: [Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        snapshot.data["dinner_credits_expiry"][position].toDate().toString() ,
                        ...
                        itemCount: snapshot.data["dinner_credits_expiry"].length
                    )
                );
              }
          )
